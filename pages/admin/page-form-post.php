...
<head>
  ...
  <!-- dropzone CSS
		============================================ -->
  <link rel="stylesheet" href="../../StyleAdmin/css/dropzone/dropzone.css">
  <!-- educate icon CSS
		============================================ -->
  ...
  <!-- summernote CSS
		============================================ -->
  <link rel="stylesheet" href="../../StyleAdmin/css/summernote/summernote.css">
  <!-- datapicker CSS
		============================================ -->
...
<body>
  ...
  <div class="all-content-wrapper">
    ...
    <?php include 'main-form-post.php'; ?>
          ...
          success: function(response) {
            if (response) {
              ...
              if (response['signal'] == 'ok') {
                $("#pesan").html("<div class=\"alert alert-success\">Data berhasil disimpan ! <a href=\"page-post.php\"><b>lihat data</b></a></div>");
                <?php if (isset($_GET['req']) && $_GET['req'] == 'add') { ?>
                  $('input,select,textarea').val('');
                <?php } ?>
              } else {
                $("#error_kodepost").html(response.msg.kodepost);
                $("#error_typepost").html(response.msg.type_post);
                $("#error_judulpost").html(response.msg.judul_post);
                $("#error_deskripsi").html(response.msg.deskripsi);
